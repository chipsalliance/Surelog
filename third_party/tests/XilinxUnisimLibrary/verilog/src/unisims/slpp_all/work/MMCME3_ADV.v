...
function [32 :1] round_frac
   (
      ...
      input [32 :1] precision 
   );

   begin
   
      // If the fractional precision bit is high then round up
      if( decimal[(10-precision)] == 1'b1) begin
         round_frac = decimal + (1'b1 << (10-precision));
      end else begin
         round_frac = decimal;
      end
   end
...
function [13:0] mmcm_divider
   ...
   begin
      ...
      duty_cycle_fix = (duty_cycle << 10) / 100_000;
      ...
      if(divide == 7'h01) begin
         ...
         high_time   = temp[10+7:10+1]; 
         // If the duty cycle * divide rounded is .5 or greater then this bit
         //    is set.
         w_edge      = temp[10]; // comes from round_frac
...
function [10:0] mmcm_phase
   ...
   reg [32 :1] phase_in_cycles;
   reg [32 :1] phase_fixed;
   reg [1:0]            mx;
   reg [5:0]            delay_time;
   reg [2:0]            phase_mux;
   ...
   begin
      ...
      // Convert to (FIXED_WIDTH-FRAC_PRECISION).FRAC_PRECISION fixed point
      if(phase < 0) begin
         phase_fixed = ( (phase + 360000) << 10 ) / 1000;
      end else begin
         phase_fixed = ( phase << 10 ) / 1000;
      end
   ...
   mx          =  2'b00; 
   phase_mux      =  temp[10:10-2];
   delay_time     =  temp[10+6:10+1];
