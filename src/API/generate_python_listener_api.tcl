...
set fid [open "${INPUT_GEN_DIR}/parser/SV3_1aParserBaseListener.h"]
...
set oid [open "${DEST_DIR}/include/Surelog/API/SV3_1aPythonListener.h" "w"]
set pid [open "${DEST_DIR}/src/API/slSV3_1aPythonListener.py" "w"]
...
puts $oid " */"
puts $oid "#ifndef SURELOG_SV3_1APYTHONLISTENER_H"
puts $oid "#define SURELOG_SV3_1APYTHONLISTENER_H"
puts $oid "#pragma once"
puts $oid ""
puts $oid "#include <Surelog/API/PythonAPI.h>"
puts $oid "#include <Surelog/ErrorReporting/ErrorDefinition.h>"
puts $oid "#include <Surelog/ErrorReporting/Location.h>"
puts $oid "#include <parser/SV3_1aParserBaseListener.h>"
puts $oid ""
puts $oid "namespace SURELOG {"
puts $oid ""
puts $oid "class PythonListen;"
puts $oid ""
...
puts $oid "    uint32_t               m_lineOffset;"
puts $oid "public:"
puts $oid "    SV3_1aPythonListener(PythonListen* pf, PyThreadState* interpState, antlr4::CommonTokenStream* tokens, uint32_t lineOffset);"
...
puts $oid "#endif /* SURELOG_SV3_1APYTHONLISTENER_H */"
