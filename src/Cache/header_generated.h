...
FLATBUFFERS_MANUALLY_ALIGNED_STRUCT(8) VObject FLATBUFFERS_FINAL_CLASS {
 ...
 public:
  ...
  VObject(uint64_t _m_field1, uint64_t _m_field2, uint64_t _m_field3, uint64_t _m_field4)
      : m_field1_(flatbuffers::EndianScalar(_m_field1)),
        ...
        m_field4_(flatbuffers::EndianScalar(_m_field4)) {
  }
  ...
  uint64_t m_field4() const {
    return flatbuffers::EndianScalar(m_field4_);
  }
};
FLATBUFFERS_STRUCT_END(VObject, 32);
...
struct TimeInfo FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef TimeInfoBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_M_TYPE = 4,
    VT_M_FILEID = 6,
    VT_M_LINE = 8,
