...
struct DesignElement FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef DesignElementBuilder Builder;
  ...
  uint32_t m_column() const {
    return GetField<uint32_t>(VT_M_COLUMN, 0);
  }
  uint32_t m_end_line() const {
    return GetField<uint32_t>(VT_M_END_LINE, 0);
  }
  uint32_t m_end_column() const {
    return GetField<uint32_t>(VT_M_END_COLUMN, 0);
  }
  ...
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<uint32_t>(verifier, VT_M_COLUMN) &&
           VerifyField<uint32_t>(verifier, VT_M_END_LINE) &&
           VerifyField<uint32_t>(verifier, VT_M_END_COLUMN) &&
...
struct DesignElementBuilder {
  ...
  void add_m_column(uint32_t m_column) {
    fbb_.AddElement<uint32_t>(DesignElement::VT_M_COLUMN, m_column, 0);
  }
  void add_m_end_line(uint32_t m_end_line) {
    fbb_.AddElement<uint32_t>(DesignElement::VT_M_END_LINE, m_end_line, 0);
  }
  void add_m_end_column(uint32_t m_end_column) {
    fbb_.AddElement<uint32_t>(DesignElement::VT_M_END_COLUMN, m_end_column, 0);
  }
...
inline flatbuffers::Offset<DesignElement> CreateDesignElement(
  ...
  builder_.add_m_end_column(m_end_column);
  builder_.add_m_end_line(m_end_line);
...
struct ParseCache FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  typedef ParseCacheBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_M_HEADER = 4,
    VT_M_ERRORS = 6,
    VT_M_SYMBOLS = 8,
