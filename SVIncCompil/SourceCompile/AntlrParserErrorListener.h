...
namespace SURELOG {
    ...
    public:
        ...
        AntlrParserErrorListener(ParseFile* parser, bool watchDogOn, unsigned int lineOffset, std::string fileName) : m_parser(parser), m_reportedSyntaxError(false),
        m_watchDogOn(watchDogOn), m_barked(false), m_lineOffset(lineOffset), m_fileName(fileName) {
        }
